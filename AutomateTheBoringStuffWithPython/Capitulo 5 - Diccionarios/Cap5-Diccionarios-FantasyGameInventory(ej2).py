''' Ejercicio 2 - Fantasy Game Inventory
...
item in the inventory and the value is an integer value detailing how many
of that item the player has.
...
def displayInventory(inventory):
    print("Inventory:")
    item_total = 0
    for k, v in inventory.items():             #tupla
        # FILL THIS PART IN
        print(v,k)
        item_total+= v
    print("Total number of items: " + str(item_total))
